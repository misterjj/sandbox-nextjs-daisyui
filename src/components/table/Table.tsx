...
import {IFilterValue, OnFilterChange} from "@/components/table/filter/Filter";
...
export interface IFilterDef<T> {
    ...
    id: string,
    label: string,
    filter: (onFilterChange: OnFilterChange) => JSX.Element,
    open?: boolean
}
...
export default function Table<T>(
    ...
    const onFilterChange = useCallback((id: string, field: keyof T, value?: IFilterValue) => {
                ...
                <div className={`relative select-none`}>
                    ...
                    <div
                        ...
                        {filterDefs?.map((filterDef, i) => {
                            return <FilterWrapper key={i} label={filterDef.label} isOpen={filterDef.open}
                                                  isPanelOpen={filterOpen}>
                                {filterDef.filter((value?: IFilterValue) => onFilterChange(filterDef.id, filterDef.field, value))}
                            </FilterWrapper>
                        })}
                    </div>
                </div>
